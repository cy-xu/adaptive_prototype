...
# import configs.ViTPose_small_simple_coco_256x192 as student_cfg
...
def main():
    ...
    student_checkpoint = student_cfg.checkpoint
    ...
    model_student.load_state_dict(torch.load(student_checkpoint)['state_dict'], strict=False)
